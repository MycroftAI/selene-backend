    ...
    public devices: Device[] = [
        {
            ...
            name: 'Mark',
            placement: {id: 'bbb-bbb-bbb', name: 'Living Room'},
            product: 'Mark I'
        },
        {
            coreVersion: '18.08',
            ...
            location: {id: 'aaa-aaa-aaa', region: 'Kansas City, MO'},
            name: 'Marky Mark',
            placement: {id: 'bbb-bbb-bbb', name: 'Kitchen'},
            product: 'Mark II'
        },
        {
            coreVersion: '18.08',
            ...
            name: 'American Pie',
            placement: {id: 'ddd-ddd-ddd', name: 'Bedroom'},
            product: 'Picroft'
        },
        {
            coreVersion: '18.08',
            ...
            placement: {id: 'fff-fff-fff', name: 'Kitchen'},
            product: 'KDE'
        }
    ];
